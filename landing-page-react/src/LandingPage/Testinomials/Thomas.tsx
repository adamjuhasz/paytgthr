...
export default function Thomas() {
  return (
    <div className="pb-12 px-4 sm:px-6 md:flex md:flex-col md:pb-16 md:pl-0 md:pr-10 lg:pr-16">
      <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
        <div className="relative text-lg font-medium text-white md:flex-grow">
          ...
          <p className="relative">
            This is a stepping stone for [my wife and I] to grow our financial
            lives together and hopefully start to invest!
          </p>
          <svg
        ...
        <footer className="mt-8">
          <div className="flex items-start">
            ...
            <div className="ml-4 flex flex-col justify-center h-20">
              <div className="text-base font-medium text-white">Thomas, 22</div>
